...
module  ov5640_top(
	...
	output wire   image_data_hs,				//输出hs
	output wire   image_data_vs,					//输出vs
...
ov5640_cfg  ov5640_cfg_inst(
  ...
  DVP_Capture DVP_Capture(
    .Rst_p      (~(sys_rst_n & sys_init_done  )),//input
    .PCLK       (ov5640_pclk      ),//input
    .Vsync      (ov5640_vsync     ),//input
    .Href       (ov5640_href      ),//input
    .Data       (ov5640_data      ),//input     [7:0]

    .ImageState (                 ),//output reg
    .DataValid  (ov5640_wr_en ),//output
    .DataPixel  (ov5640_data_out       ),//output    [15:0]
    .DataHs     (image_data_hs    ),//output
    .DataVs     (image_data_vs    ),//output
    .Xaddr      ( x_addr                ),//output    [11:0]
    .Yaddr      ( y_addr               ) //output    [11:0]
  );
